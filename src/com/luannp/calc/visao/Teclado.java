...
public class Teclado extends JPanel {
    ...
    private final Color COR_AZUL_ESCURO = new Color(0, 0, 139);
    ...
    public Teclado() {
        ...
        adicionarBotao("=", COR_AZUL_ESCURO, c, 3, 4);
    }
